...
%DATCOM outputs from DATCOM v1_01
    ...
    % arrays
user_input.AoA_deg = [-4 -2 0 2 4 6 8 10 12 14 16];

user_input.elevator_deflection_deg = [-10 -5 0 5 10];

user_input.delta_C_L_elevator = [-0.064 -0.032 0 0.032 0.064];

user_input.delta_C_m_elevator = [0.1368 0.0690 -0.0001 -0.0690 -0.1380];

user_input.C_L_AoA_deg = [-0.183 0.020 0.227 0.439 0.656 0.878 1.102 1.295 1.459 1.590 1.646];

user_input.C_L_delta_e = 0.3667;

user_input.C_D_AoA_deg = [0.026 0.024 0.026 0.031 0.040 0.052 0.068 0.084 0.101 0.117 0.126];

user_input.C_m_AoA_deg = -0.01408;
...
user_input.C_m_alpha = -0.8067;

user_input.C_L0 = 0.227;

    %The pitch rate as a derivative

user_input.C_L_q = 0.1528;

user_input.C_m_q =-3.273;
